...
#define OR(l,r)		do { count_alu(); ALU(0x0b, (l),(r));			asm_output2("or %s,%s",gpn(l),gpn(r)); } while(0)
#define AND(l,r)	do { count_alu(); ALU(0x23, (l),(r));			asm_output2("and %s,%s",gpn(l),gpn(r)); } while(0)
#define XOR(l,r)	do { count_alu(); ALU(0x33, (l),(r));			asm_output2("xor %s,%s",gpn(l),gpn(r)); } while(0)
#define ADD(l,r)	do { count_alu(); ALU(0x03, (l),(r));			asm_output2("add %s,%s",gpn(l),gpn(r)); } while(0)
#define SUB(l,r)	do { count_alu(); ALU(0x2b, (l),(r));			asm_output2("sub %s,%s",gpn(l),gpn(r)); } while(0)
#define MUL(l,r)	do { count_alu(); ALU2(0x0faf,(l),(r));		asm_output2("mul %s,%s",gpn(l),gpn(r)); } while(0)
#define NOT(r)		do { count_alu(); ALU(0xf7, (Register)2,(r));	asm_output1("not %s",gpn(r)); } while(0)
#define NEG(r)		do { count_alu(); ALU(0xf7, (Register)3,(r));	asm_output1("neg %s",gpn(r)); } while(0)
#define SHR(r,s)	do { count_alu(); ALU(0xd3, (Register)5,(r));	asm_output2("shr %s,%s",gpn(r),gpn(s)); } while(0)
#define SAR(r,s)	do { count_alu(); ALU(0xd3, (Register)7,(r));	asm_output2("sar %s,%s",gpn(r),gpn(s)); } while(0)
#define SHL(r,s)	do { count_alu(); ALU(0xd3, (Register)4,(r));	asm_output2("shl %s,%s",gpn(r),gpn(s)); } while(0)
...
#define SHLi(r,i)	do { count_alu(); SHIFT(4,r,i);	asm_output2("shl %s,%d", gpn(r),i); } while(0)
#define SHRi(r,i)	do { count_alu(); SHIFT(5,r,i);	asm_output2("shr %s,%d", gpn(r),i); } while(0)
#define SARi(r,i)	do { count_alu(); SHIFT(7,r,i);	asm_output2("sar %s,%d", gpn(r),i); } while(0)

#define MOVZX8(d,s) do { count_alu(); ALU2(0x0fb6,d,s); asm_output2("movzx %s,%s", gpn(d),gpn(s)); } while(0)

#define SUBi(r,i)	do { count_alu(); ALUi(0x2d,r,i);				asm_output2("sub %s,%d",gpn(r),i); } while(0)
#define ADDi(r,i)	do { count_alu(); ALUi(0x05,r,i);				asm_output2("add %s,%d",gpn(r),i); } while(0)
#define ANDi(r,i)	do { count_alu(); ALUi(0x25,r,i);				asm_output2("and %s,%d",gpn(r),i); } while(0)
...
#define SETNP(r)	do { count_alu(); ALU2(0x0f9B,(r),(r));			asm_output1("setnp %s",gpn(r)); } while(0)
#define SETL(r)		do { count_alu(); ALU2(0x0f9C,(r),(r));			asm_output1("setl %s",gpn(r)); } while(0)
#define SETLE(r)	do { count_alu(); ALU2(0x0f9E,(r),(r));			asm_output1("setle %s",gpn(r)); } while(0)
#define SETG(r)		do { count_alu(); ALU2(0x0f9F,(r),(r));			asm_output1("setg %s",gpn(r)); } while(0)
#define SETGE(r)	do { count_alu(); ALU2(0x0f9D,(r),(r));			asm_output1("setge %s",gpn(r)); } while(0)
#define SETB(r)     do { count_alu(); ALU2(0x0f92,(r),(r));          asm_output1("setb %s",gpn(r)); } while(0)
#define SETBE(r)    do { count_alu(); ALU2(0x0f96,(r),(r));          asm_output1("setbe %s",gpn(r)); } while(0)
#define SETA(r)     do { count_alu(); ALU2(0x0f97,(r),(r));          asm_output1("seta %s",gpn(r)); } while(0)
#define SETAE(r)    do { count_alu(); ALU2(0x0f93,(r),(r));          asm_output1("setae %s",gpn(r)); } while(0)
#define SETC(r)     do { count_alu(); ALU2(0x0f90,(r),(r));          asm_output1("setc %s",gpn(r)); } while(0)
#define SETO(r)     do { count_alu(); ALU2(0x0f92,(r),(r));          asm_output1("seto %s",gpn(r)); } while(0)

#define MREQ(dr,sr)	do { count_alu(); ALU2(0x0f44,dr,sr); asm_output2("cmove %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRNE(dr,sr)	do { count_alu(); ALU2(0x0f45,dr,sr); asm_output2("cmovne %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRL(dr,sr)	do { count_alu(); ALU2(0x0f4C,dr,sr); asm_output2("cmovl %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRLE(dr,sr)	do { count_alu(); ALU2(0x0f4E,dr,sr); asm_output2("cmovle %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRG(dr,sr)	do { count_alu(); ALU2(0x0f4F,dr,sr); asm_output2("cmovg %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRGE(dr,sr)	do { count_alu(); ALU2(0x0f4D,dr,sr); asm_output2("cmovge %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRB(dr,sr)	do { count_alu(); ALU2(0x0f42,dr,sr); asm_output2("cmovb %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRBE(dr,sr)	do { count_alu(); ALU2(0x0f46,dr,sr); asm_output2("cmovbe %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRA(dr,sr)	do { count_alu(); ALU2(0x0f47,dr,sr); asm_output2("cmova %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRNC(dr,sr)	do { count_alu(); ALU2(0x0f43,dr,sr); asm_output2("cmovnc %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRAE(dr,sr)	do { count_alu(); ALU2(0x0f43,dr,sr); asm_output2("cmovae %s,%s", gpn(dr),gpn(sr)); } while(0)
#define MRNO(dr,sr)	do { count_alu(); ALU2(0x0f41,dr,sr); asm_output2("cmovno %s,%s", gpn(dr),gpn(sr)); } while(0)
...
#define FMUL(d,b)	do { count_fpu(); FPUm(0xdc01, d, b);		asm_output2("fmul %d(%s)",d,gpn(b)); } while(0)
#define FDIV(d,b)	do { count_fpu(); FPUm(0xdc06, d, b);		asm_output2("fdiv %d(%s)",d,gpn(b)); } while(0)
#define FDIVR(d,b)	do { count_fpu(); FPUm(0xdc07, d, b);		asm_output2("fdivr %d(%s)",d,gpn(b)); } while(0)
#define FINCSTP()	do { count_fpu(); FPUc(0xd9f7);				asm_output2("fincstp"); } while(0)
